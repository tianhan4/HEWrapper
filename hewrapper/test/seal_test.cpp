...
typedef EncryptionParameters SEALEncryptionParameters;
typedef Wrapper SEALWrapper;
typedef Plaintext SEALPlaintext;
typedef Ciphertext SEALCiphertext;
...
void example_ckks_basics() {
    ...
    EncryptionParameters parms(seal_scheme::CKKS);
    ...
    Ciphertext x1_encrypted(decryptor, x_plain);

    print_line(__LINE__);
    cout << "Compute x^2 and relinearize:" << endl;
    Ciphertext x3_encrypted = x1_encrypted * x1_encrypted;
    ...
    Ciphertext x1_encrypted_coeff3 = x1_encrypted * plain_coeff3;
    ...
    // TODO check the scale above
    /*
    Ciphertext encrypted_result = x3_encrypted + x1_encrypted;
    ...
    */
    ...
    /*
    plain_result = encrypted_result.decrpty(decryptor);
